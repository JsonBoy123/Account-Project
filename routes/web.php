...
Route::get('site-expense','HistoryController@index')->name('site-expense');
Route::get('site-cost/{id}','HistoryController@sitecost')->name('site-cost');
Route::get('site-pdf/{id}','HistoryController@sitePdf')->name('site-pdf');
...
Route::get('/rec-item/{id}','MasterController@recitem')->name('rec-item');
Route::post('/site-in','MasterController@sitein')->name('site-in');
Route::get('/site-again/{id}/{site}/{wh}','MasterController@siteagain')->name('site-again');

Route::get('/itemws/{id}','MasterController@itemws')->name('itemws');
Route::post('/iqsupdate/','SiteUserMangController@iqsupdate')->name('iqsupdate');
...
Route::get('generate-bill/{id}','SalesController@generatebill')->name('generate-bill');
...
Route::get('generate-Pbill/{id}','PurchaseController@generatePaybill')->name('generate-Pbill');
...
Route::get('site-item-list', 'SiteitemmanageController@siteitemlist')->name('site-item-list');
