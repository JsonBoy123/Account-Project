...
class PurchaseController extends Controller
{
  ...
  public function __construct()
   ...
   public function purchasedetails($id){
    ...
    $edit = PurchaseModel::with('company','job')->where('id',$id)->first();
    $ckamt = PurchaseModel::find($id)->checkamount;
    return view('pages.purchasedetails',compact('edit','ckamt'));
   }

   public function generatePaybill($id){
    $gene = PurchaseModel::with('company','job')->where('id',$id)->first();
    $ckamt = PurchaseModel::find($id)->checkamount;
    $pdf = PDF::loadView('pages.PaYbillPdf', compact('gene','ckamt'));
    return $pdf->download('Sub-contractorbill.pdf');
   }
