...
class P_assingnController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $Pclient = VendorMast::find($request->client_id);
    ...
    public function getpclient(Request $request){
      ...
      return $client_new =  VendorMast::where('vendor_type','2')->wherenotIn('id',$ids)->get();
    }
    ...
    public function pettylist(){
        ...
        $petty = VendorMast::where('vendor_type','2')->get();
