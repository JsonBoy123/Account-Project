                ...
                <table class="table table-hover table-bordered" id="sampleTable13">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     {{--  <td><a href="{{ route('site-item-list') }}" class="text-secondary btn-sm">Avail Item</a></td> --}}
                      ...
                      <td>
                        @role(['acco_super_admin','acco_admin','acco_manager','acco_user'])
                         <a href="{{ route('rec-item',[$perm->id]) }}"><button class="btn btn-success btn-sm"><i class="fa fa-cc" aria-hidden="true"></i></button></a>
                         <a href="{{ route('itemws',[$perm->id]) }}"><button class="btn btn-primary btn-sm"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button></a>
                      </td>
                      @endrole
                    </tr>
                     <?php $s_no++ ?>
