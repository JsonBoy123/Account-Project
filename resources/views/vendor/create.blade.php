            ...
            <div class="row">
              <div class="col-lg-4">
                 ...
                 <select name="vendor_type" id="vendor_type" class="form-control">
                    ...
                    <option value="{{ $vname->id }}" {{ old('vendor_type') == $vname->id ? 'selected' : '' }}>{{ $vname->name }}</option>
                    @endforeach
                ...
                <div class="col-lg-4">
                  ...
                  <select name="firm_type" id="vendor_type" class="form-control">
                    ...
                    <option value="{{ $fname->id }}" {{ old('firm_type') == $fname->id ? 'selected' : '' }}>{{ $fname->name }}</option>
                    @endforeach
              ...
              <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                 <div class="form-group">
                    ...
                    <textarea class="form-control" type="text" name="address" value="{{ old('address') }}" placeholder="Enter Address" autocomplete="off"></textarea>
                     @error('address')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="gst" style="display: none;">GSTIN</label>
                    <input class="form-control" type="text" id="gst_number" name="gst_number" value="{{ old('gst_number') }}" placeholder="Enter Gst Number" style="display: none;" autocomplete="off">
                    <span id="gstin"></span>
                      @error('gst_number')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="sgst" style="display: none;">SGST</label>
                    <input class="form-control" type="text" id="sgst_number" name="sgst_number" value="{{ old('sgst_number') }}" placeholder="Enter SGST Number" style="display: none;" autocomplete="off">
                    <span id="sgst_number"></span>
                      @error('sgst_number')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
              ...
              {{-- <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="vendor-limit">Vendor Max Limit</label>
                    <input class="form-control" type="text" name="max_limit" value="{{ old('max_limit') }}" placeholder="Enter Max Limit" autocomplete="off">
                     @error('max_limit')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label for="vendor_cat_id">Vendor Category</label>
...
$(document).ready(function(){
 $.viewField = {
    '0' : $([]),
    'Reg' : $('#gst_number , #sgst_number')
   };
  $('#gst_type').change(function() {
    
    $.each($.viewField, function() { this.hide(); });
    
    $.viewField[$(this).val()].show();
  });
  ...
  $.ajax({
      ...
      //console.log(res);
            $("#city").empty();
            $("#city").append('<option value="574">Select District</option>');
