...
<main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li class="breadcrumb-item active"><a href="{{route('vendor.create')}}"><button class="btn btn-primary"><i class="fa fa-lg fa-plus"></i>Create Vendor</button></a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
      ...
      @endif 
          <div class="tile">
           ...
           <!--  <div class="tile-footer">
                <a href=""><button class="btn btn-primary"><i class="fa fa-lg fa-plus"></i>Create Vendor</button></a>
              </div> -->
        </div>
      </div>
