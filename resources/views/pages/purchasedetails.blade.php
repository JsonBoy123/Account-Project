            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="bill_desc" name="bill_desc" type="text" aria-describedby="emailHelp" value="{{ $edit->job->name }}" placeholder="Enter Work Name For Billing" readonly="">
                     @error('bill_desc')
                    <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="col-lg-4">
               ...
               <div class="row">
                ...
                <div class="col-lg-6">
                  <a href="{{ route('generate-Pbill',['id'=> $edit->id])}}" class="btn btn-danger">Get PDF</a>
                </div>
              </div>
