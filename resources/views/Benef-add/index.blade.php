...
<main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li class="breadcrumb-item active"><a href="{{ route('benef-create')}}"><button class="btn btn-primary">Add Request</button></a></li>
        </ul>
      </div>
      ...
      @endif 
          <div class="tile">
            ...
            <!-- <div class="tile-footer">
                <a href=""><button class="btn btn-primary">Add Request</button></a>
              </div> -->
        </div>
      </div>
